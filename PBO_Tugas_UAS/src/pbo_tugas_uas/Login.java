...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            Connection dbconn = Config.getConnection();
            PreparedStatement st = (PreparedStatement)
            dbconn.prepareStatement("SELECT * FROM datalogin WHERE username = ? AND password = ?");
            ...
            if(res.next()){
                ...
                txtUsername.setText("");
                txtPassword.setText("");
                JOptionPane.showMessageDialog(this,"Username dan Password Tidak Terdaftar !", "Peringatan", JOptionPane.WARNING_MESSAGE);
            }
